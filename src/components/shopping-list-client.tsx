  ...
  return (
    <div className="space-y-8">
      <div className="recipe-hero p-6 sm:p-8">
        <div className="recipe-hero-content flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
      ...
      <Card className="recipe-surface border-border/70 bg-card/95 shadow-[0_14px_30px_rgba(58,45,34,0.12)]">
        <CardHeader>
